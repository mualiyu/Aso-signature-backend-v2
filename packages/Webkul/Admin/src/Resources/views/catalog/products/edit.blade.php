    ...
    <x-slot:title>
        ...
        <x-admin::form method="PUT" enctype="multipart/form-data">
            ...
            <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
                ...
                {!! view_render_event("bagisto.admin.catalog.product.edit.form.column_{$column}.before", ['product' =>
                $product]) !!}
                ...
                <div
                    ...
                    {!! view_render_event("bagisto.admin.catalog.product.edit.form.{$group->code}.before", ['product' =>
                    $product]) !!}
                    ...
                    <div class="box-shadow relative rounded bg-white p-4 dark:bg-gray-900">
                        ...
                        {!! view_render_event("bagisto.admin.catalog.product.edit.form.{$group->code}.controls.after",
                        ['product' => $product]) !!}
                        @endforeach
                        ...
                        {{-- @includeWhen(
                        $group->code === 'designers',
                        'admin::catalog.products.edit.designers'
                        ) --}}


                    </div>

                    {!! view_render_event("bagisto.admin.catalog.product.edit.form.{$group->code}.after", ['product' =>
                    $product]) !!}
                    @endif
                    @endforeach
                ...
                {!! view_render_event("bagisto.admin.catalog.product.edit.form.column_{$column}.after", ['product' =>
                $product]) !!}
