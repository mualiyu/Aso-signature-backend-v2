    ...
    'sales' => [
        'orders' => [
            ...
            'view' => [
                ...
                'shipments'                      => 'Shipments',
                'shipped'                        => 'Shipped',
                'status-changed-comment'         => 'Order status changed from :from to :to.',
                'status-transition-invalid'      => 'Invalid status change. Please choose a valid next step in the workflow.',
        ...
        'shipments' => [
            ...
            'create' => [
                ...
                'dhl-documents-warning' => 'DHL shipment was created and tracking was assigned, but the shipping paperwork PDF could not be saved. Check storage/logs/laravel.log or open the shipment view for details.',
            ...
            'view' => [
                ...
                'dhl-track-online'            => 'Track your shipment online',
                'dhl-last-status'             => 'Latest DHL status',
                'dhl-refresh-tracking'        => 'Refresh DHL tracking status',
                'dhl-tracking-refreshed'      => 'DHL tracking status updated.',
                'dhl-tracking-error'          => 'Could not refresh DHL tracking: :message',
                'dhl-tracking-not-applicable' => 'DHL tracking is only available for DHL Express shipments.',
                'cancel-shipment'             => 'Cancel this shipment',
                'cancel-confirm-msg'          => 'This will delete the shipment, restore stock and let you create a new one. The DHL waybill will not be used and expires unbilled. Continue?',
                'cancel-success'              => 'Shipment cancelled. Stock has been restored — you can now create a new shipment for this order.',
                'cancel-blocked-in-transit'   => 'This shipment has already been scanned by DHL (:status). It can no longer be cancelled here — please contact DHL to stop or return it.',
                'cancel-blocked-refunded'     => 'Items on this shipment have been refunded. Cancel it manually to avoid restoring stock twice.',
                'cancel-tracking-unverified'  => 'Could not verify the shipment status with DHL (:message). Please try again.',
                'cancel-pickup-warning'       => 'Shipment was cancelled locally, but the DHL courier pickup could not be cancelled (:message). Please cancel the pickup with DHL manually.',
                'cancel-not-applicable'       => 'Cancellation is only available for DHL Express shipments.',
                'pickup-title'                => 'Courier Pickup',
                'book-pickup'                 => 'Book Pickup',
                'cancel-pickup'               => 'Cancel Pickup',
                'pickup-date'                 => 'Planned pickup date',
                'pickup-close-time'           => 'Location close time',
                'pickup-location'             => 'Pickup location',
                'pickup-location-type'        => 'Location type',
                'pickup-location-business'    => 'Business',
                'pickup-location-residence'   => 'Residence',
                'pickup-booked'               => 'Pickup booked — confirmation #:number',
                'pickup-success'              => 'DHL pickup booked successfully (confirmation #:number).',
                'pickup-cancel-success'       => 'DHL pickup cancelled successfully.',
                'pickup-cancel-confirm'       => 'Cancel this DHL courier pickup?',
                'pickup-error'                => 'Could not book DHL pickup: :message',
                'pickup-cancel-error'         => 'Could not cancel DHL pickup: :message',
                'pickup-already-booked'       => 'A pickup is already booked for this shipment. Cancel it before booking a new one.',
                'pickup-not-booked'           => 'No DHL pickup is booked for this shipment.',
                'pickup-cancel-in-transit'    => 'The parcel has already been scanned by DHL, so the pickup can no longer be cancelled here.',
                'pickup-not-applicable'       => 'Pickup booking is only available for DHL Express shipments.',
            ],
        ],
        ...
        'themes' => [
            ...
            'create' => [
                ...
                'type' => [
                    ...
                    'designer-carousel'  => 'Designer Carousel',
            ...
            'edit' => [
                ...
                'designer-carousel-description'  => 'Showcase Designers elegantly with a dynamic and responsive Designer carousel.',
                'save-btn'                       => 'Save',
                'select'                         => 'Select',
                'slider'                         => 'Slider',
                ...
                'hero-carousel' => [
                    'add-btn'                  => 'Add Hero Slide',
                    'autoplay'                 => 'Rotate automatically',
                    'cta-link'                 => 'Primary Button Link',
                    'cta-text'                 => 'Primary Button Label',
                    'delete'                   => 'Delete',
                    'hours'                    => 'Hours',
                    'interval'                 => 'Show each slide for',
                    'minutes'                  => 'Minutes',
                    'rotation'                 => 'Rotation',
                    'rotation-info'            => 'How long each slide stays on screen before the next one. The schedule runs on the clock, not per visitor: everyone sees the same slide at the same moment, and long intervals work even if nobody keeps the page open.',
                    'rotation-off'             => 'Rotation is off, so only the first slide will ever be shown.',
                    'rotation-restart'         => 'Saving will start the rotation from slide 1 at that moment, for every visitor at once.',
                    'rotation-schedule'        => 'Counted from :started. Visitors are seeing slide :current right now; it changes to slide :next at :at.',
                    'rotation-schedule-fast'   => 'Counted from :started, so every visitor sees the same slide at the same moment.',
                    'rotation-single'          => 'Add a second slide to start rotating.',
                    'rotation-summary'         => 'Each of the :count slides shows for :duration; a full loop takes :count x :duration.',
                    'seconds'                  => 'Seconds',
                    'desktop-image'            => 'Desktop Image',
                    'desktop-image-size'       => 'Recommended resolution 2400px X 1350px (16:9). Leave generous empty space on the side opposite the text.',
                    'heading'                  => 'Heading',
                    'hero'                     => 'Hero Slides',
                    'hero-info'                => 'Full width hero banners with a heading, supporting text and call to action buttons laid over the image.',
                    'image-required'           => 'A desktop image is required.',
                    'mobile-image'             => 'Mobile Image (optional)',
                    'mobile-image-size'        => 'Recommended resolution 1080px X 1350px (4:5). The desktop image is used when this is left empty.',
                    'none'                     => 'None',
                    'save-btn'                 => 'Save',
                    'secondary-cta-link'       => 'Secondary Button Link',
                    ...
                    'update-slide'             => 'Update Hero Slide',
                ],
        ...
        'index' => [
            ...
            'email' => [
                ...
                'notifications' => [
                    ...
                    'order-status-update'                              => 'Send a notification e-mail to the customer whenever the order status changes',
