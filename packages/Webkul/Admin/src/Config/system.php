...
return [
    ...
    [
        ...
        'name'   => 'DHL Express',
        'info'   => 'DHL Express Shipping Configuration',
        'sort'   => 3,
        'fields' => [
            [
                'name'          => 'title',
                ...
                'name'          => 'origin_country',
                'title'         => 'Origin Country Code (US, UK, etc.)',
                'type'          => 'text',
                'validation'    => 'required_if:active,1',
                'channel_based' => true,
                'locale_based'  => false,
                ...
                'name'          => 'origin_address',
                'title'         => 'Origin Address (line 1)',
                'type'          => 'text',
                'info'          => 'DHL allows max 45 characters per line; longer values are truncated for API requests.',
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'origin_address_line_2',
                'title'         => 'Origin Address (line 2)',
                'type'          => 'text',
                'info'          => 'DHL allows max 45 characters per line; longer values are truncated for API requests.',
                'channel_based' => true,
                'locale_based'  => false,
                ...
                'name'          => 'default_commodity_code_outbound',
                ...
                'name'          => 'default_commodity_code_inbound',
                ...
                'name'          => 'invoice_language_code',
                'title'         => 'Commercial invoice language',
                'type'          => 'text',
                'default'       => 'eng',
                'channel_based' => true,
                'locale_based'  => false,
                ...
                'name'          => 'template_label',
                'title'         => 'Label template (override)',
                'type'          => 'text',
                'info'          => 'Leave empty for ECOM26_84_A4_001',
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'template_waybill',
                'title'         => 'Waybill template (override)',
                'type'          => 'text',
                'info'          => 'Leave empty for ARCH_8X4_A4_002',
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'dhl_receiver_show_company_on_label',
                'title'         => 'Show company name on DHL receiver label',
                'type'          => 'boolean',
                'default'       => false,
                'info'          => 'When off, companyName is still sent (required by DHL) using the customer name, not the store company_name. Turn on to use the address company_name on the label.',
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'template_invoice',
                'title'         => 'Invoice template (override)',
                'type'          => 'text',
                'info'          => 'Leave empty for COMMERCIAL_INVOICE_P_10',
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'default_length',
                ...
                'name'          => 'pickup_date_strategy',
                'title'         => 'Planned pickup date',
                'type'          => 'select',
                'default'       => 'auto',
                'info'          => 'How to calculate plannedShippingDateAndTime sent to DHL for rates and shipments.',
                'channel_based' => true,
                'locale_based'  => false,
                'options'       => [
                    [
                        'title' => 'Auto — today before cutoff, otherwise next day',
                        'value' => 'auto',
                    ], [
                        'title' => 'Next day (then skip weekends if enabled)',
                        'value' => 'next_business_day',
                    ], [
                        'title' => 'Today',
                        'value' => 'today',
                    ], [
                        'title' => 'Offset from today (use Additional days)',
                        'value' => 'offset_days',
                    ],
                ],
            ], [
                'name'          => 'pickup_time',
                'title'         => 'Pickup time (24h)',
                'type'          => 'text',
                'default'       => '10:00',
                'info'          => 'Local time for planned pickup, e.g. 10:00 or 14:30.',
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'pickup_cutoff_hour',
                'title'         => 'Same-day cutoff hour',
                'type'          => 'text',
                'default'       => '15',
                'info'          => 'For Auto: after this hour (0–23), pickup rolls to the next day.',
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'pickup_offset_days',
                'title'         => 'Additional days to add',
                'type'          => 'text',
                'default'       => '0',
                'info'          => 'Extra days after the strategy (0–30). For Offset strategy, minimum 1 day.',
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'pickup_offset_business_days',
                'title'         => 'Count additional days as business days only',
                'type'          => 'boolean',
                'default'       => true,
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'pickup_skip_weekends',
                'title'         => 'Skip Saturdays and Sundays',
                'type'          => 'boolean',
                'default'       => true,
                'channel_based' => true,
                'locale_based'  => false,
                ...
                'title'         => 'Pickup timezone (optional)',
                'type'          => 'text',
