...
@pushOnce('scripts')
    ...
    <script type="module">
        ...
        app.component('v-measurement-chips', {
            ...
            methods: {
                /**
                 * The shop header is sticky, so the strip must pin just below it.
                 */
                updateStickyTop() {
                ...
                observeSentinel() {
                    ...
                    this.observer = new IntersectionObserver(([entry]) => {
                        this.isStuck = ! entry.isIntersecting && entry.boundingClientRect.top < this.stickyTop;
                    }, {
