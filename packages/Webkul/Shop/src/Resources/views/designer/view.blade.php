...
<x-shop::layouts>
    ...
    <x-slot:title>
        ...
        <div class="mt-6 px-0 max-md:mt-4 max-md:px-2">
            <div
                class="bg-gradient-to-br from-pink-50 via-white to-blue-50 rounded-3xl shadow-2xl px-12 py-0 flex flex-col md:flex-row gap-12 items-center animate__animated animate__fadeIn"
            ...
            @endif
                @if ($designer->logo && $designer->logo->src)
                    <div class="relative group">
                        <img src="{{ $designer->logo->src ? url("/storage")."/".$designer->logo->src : bagisto_asset('images/small-product-placeholder.webp') }}"
                            ...
                            class="w-40 h-40 object-cover rounded-full border-4 border-white shadow-lg ring-4 ring-pink-200 transition-transform duration-500 group-hover:scale-105" />
                        <span class="absolute bottom-2 right-2 bg-white rounded-full px-3 py-1 text-xs font-semibold text-pink-500 shadow animate__animated animate__bounceIn">
                            {{-- Designer --}}
                        </span>
                    </div>
                @endif
                ...
                <div class="flex-1">
                    <h1 class="text-5xl font-extrabold text-navyBlue mb-4 tracking-tight leading-tight animate__animated animate__fadeInDown">
                        {{ $designer->name }}
                    </h1>
                    <p class="text-lg text-gray-700 mb-6 italic leading-relaxed animate__animated animate__fadeInUp">{!! $designer->description !!}</p>

                    <div class="flex flex-wrap gap-4 items-center mt-4">
                        @if ($designer->website)
                            <a href="{{ $designer->website }}" target="_blank"
                                class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 text-blue-700 hover:bg-blue-100 transition font-medium shadow hover:scale-105 duration-300 animate__animated animate__fadeInLeft"
                        ...
                        @if ($designer->instagram)
                            <a href="{{ $designer->instagram }}" target="_blank"
                                class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-pink-50 text-pink-600 hover:bg-pink-100 transition font-medium shadow hover:scale-105 duration-300 animate__animated animate__fadeInLeft"
                        ...
                        @if ($designer->facebook)
                            <a href="{{ $designer->facebook }}" target="_blank"
                                class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 text-blue-800 hover:bg-blue-100 transition font-medium shadow hover:scale-105 duration-300 animate__animated animate__fadeInLeft"
                        ...
                        @if ($designer->twitter)
                            <a href="{{ $designer->twitter }}" target="_blank"
                                class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-sky-50 text-sky-500 hover:bg-sky-100 transition font-medium shadow hover:scale-105 duration-300 animate__animated animate__fadeInLeft"
                        ...
                        @if ($designer->linkedin)
                            <a href="{{ $designer->linkedin }}" target="_blank"
                                class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 text-blue-900 hover:bg-blue-100 transition font-medium shadow hover:scale-105 duration-300 animate__animated animate__fadeInLeft"
                        ...
                        @if ($designer->youtube)
                            <a href="{{ $designer->youtube }}" target="_blank"
                                class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-50 text-red-600 hover:bg-red-100 transition font-medium shadow hover:scale-105 duration-300 animate__animated animate__fadeInLeft"
                        ...
                        @if ($designer->pinterest)
                            <a href="{{ $designer->pinterest }}" target="_blank"
                                class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-50 text-red-500 hover:bg-red-100 transition font-medium shadow hover:scale-105 duration-300 animate__animated animate__fadeInLeft"
                    ...
                    <div class="mt-8 grid grid-cols-2 gap-6 text-base text-gray-600 animate__animated animate__fadeInUp" style="animation-delay:0.8s;">
                        @if ($designer->phone)
                            <div class="flex items-center gap-2">
                                <span class="font-semibold text-navyBlue">Phone:</span>
                                <a href="tel:{{ $designer->phone }}" class="hover:underline text-[#0f9e22] font-medium animate__animated animate__pulse animate__infinite">{{
                                    $designer->phone }}</a>
                            </div>
                        @endif
                    </div>
